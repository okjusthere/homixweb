...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    `- [RMB purchase options](${base}/rmb-homes): ${featuredDevelopments.filter((building) => building.rmbEligible).length} New York new-development projects currently marked with RMB payment availability`,
