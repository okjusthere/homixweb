        ...
        <Container>
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:gap-10">
            {t.bootcamps.map((bootcamp, bootcampIndex) => (
              <Reveal key={bootcamp.title} delay={bootcampIndex * 80}>
                <figure>
                  ...
                  <figcaption className="mt-4">
                    <h3 className="font-serif text-xl leading-tight text-ink">{bootcamp.title}</h3>
                    <p className="mt-1 text-sm text-muted">{bootcamp.subtitle}</p>
                  </figcaption>
                </figure>
              </Reveal>
            ))}
