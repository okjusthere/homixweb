...
const copy = {
  en: {
    meta: {
      ...
      description:
        "Compare Homix Realty's Solo, Solo Pro, and Team commission plans, including 85/15 and 90/10 splits, annual caps, 100% commission mode, lead fees, and sponsor rewards.",
    },
    hero: {
      eyebrow: "Homix commission & growth",
      title: "Keep more as your business grows.",
      lead: "Choose an independent, 100%, or team path. Every plan makes the split, annual cap, post-cap economics, and lead fees visible before you join.",
    ...
    plans: {
      ...
      title: "Three clear ways to build at Homix.",
      lead: "Your source of business does not choose your plan. You choose how you want to work; source economics apply only when a lead comes from Homix or an outside referral.",
      ...
      items: [
        {
          ...
          split: "85 / 15",
          splitNote: "on eligible commission before cap",
          capValue: "$12,000",
          capNote: "Homix company dollar",
          result: "100% commission mode",
          body: "At a 15% company split, approximately $80,000 of eligible commission allocation reaches the annual cap.",
        },
        {
          tag: "High production",
          name: "Solo Pro",
          ...
          split: "100%",
          splitNote: "from the first closing",
          capValue: "No split cap",
          capNote: "transaction fee schedule applies",
          result: "100% from day one",
        ...
        },
        {
          ...
          feeNote: "or $500 / 2 years prepaid",
          split: "90 / 10",
          splitNote: "Homix brokerage economics",
          capValue: "$10,000",
          capNote: "Homix company dollar",
          result: "100% Homix mode",
          body: "Team economics are separate and documented in the team agreement. Homix recommends a 10% team split as the starting profile. Team Leaders default to Solo Pro.",
        },
      ],
      note: "The $500 two-year membership is prepaid and saves $76 compared with two annual $288 payments. Solo Pro and Team Leader pricing already includes the base affiliation fee.",
    },
    cap: {
      eyebrow: "The cap",
      title: "A finish line, not a forever split.",
      lead: "Company dollar accumulates from eligible commission during your individual anniversary year. Reach the cap, and the rest of that year moves to 100% commission mode.",
      solo: {
        name: "Solo",
        split: "15%",
        cap: "$12,000 cap",
        after: "100% mode",
        stages: [
          ["Before cap", "15% builds toward $12,000"],
      ...
      team: {
        ...
        after: "100% Homix mode",
        stages: [
          ["Before cap", "10% builds toward $10,000"],
          ["Team economics", "A separate team split follows the signed team profile"],
          ["After Homix cap", "Transaction fee applies; team terms continue separately"],
        ],
      },
      reset: "Caps reset on the agent's anniversary, not January 1. Outside referrals, sponsor payouts, transaction fees, and third-party charges do not create cap credit.",
    },
    example: {
      ...
      items: [
        ...
        },
        {
          ...
          detail: "$1,000 Homix company dollar, then $900 to the Team Leader under the recommended 10% team profile.",
        },
      ],
      ...
      items: [
        {
          ...
          a: "The cap is the maximum Homix company dollar generated by the normal split during your anniversary year: $12,000 for Solo and $10,000 for a Team Member. Once reached, the Homix split stops for the rest of that year and 100% commission mode begins.",
        },
        {
        ...
        },
        {
          ...
          a: "No. Homix brokerage economics are fixed at 90/10 with a $10,000 Homix cap. The Team split is separate and comes from the remaining agent side. Homix recommends 10%; approved default presets are 10%, 15%, or 20%, while a genuine team-generated lead may use an approved 10%–30% preset. Any optional Team Cap and the effective configuration are documented in the signed team profile.",
        },
        {
  ...
  zh: {
    meta: {
      ...
      description:
        "了解 Homix Realty 的 Solo、Solo Pro 与 Team 佣金方案，包括 85/15、90/10 分成、年度封顶、100% 佣金模式、公司客源费与 Sponsor 奖励。",
    },
    hero: {
      eyebrow: "Homix 佣金与成长方案",
      title: "业务越成熟，留给自己的越多。",
      lead: "独立发展、从第一单进入 100%，或加入团队——每条路径都把分成、年度封顶、封顶后规则与客源费用提前讲清楚。",
      primary: "比较三种方案",
    ...
    plans: {
      eyebrow: "选择发展路径",
      title: "三种清晰方案，对应三种工作方式。",
      lead: "方案不再按出租或买卖划分，而是由你选择想怎样发展。只有当客源来自 Homix 或外部 referral 时，才会先处理对应的客源经济规则。",
      annualFee: "会员费用",
      commission: "佣金分成",
      cap: "年度封顶",
      afterCap: "封顶后",
      items: [
        {
          ...
          split: "85 / 15",
          splitNote: "封顶前按 eligible commission 计算",
          capValue: "$12,000",
          capNote: "Homix Company Dollar",
          result: "进入 100% 佣金模式",
          body: "按 15% 公司分成计算，约 $80,000 的 eligible commission allocation 即可达到年度封顶。",
        },
        {
          tag: "高产经纪人",
          name: "Solo Pro",
          ...
          splitNote: "从第一笔成交开始",
          capValue: "无需累计封顶",
          capNote: "每单按 Transaction Fee 档位收费",
          result: "第一天即为 100%",
        ...
        },
        {
          ...
          capValue: "$10,000",
          capNote: "Homix Company Dollar",
          result: "进入 Homix 100% 模式",
          body: "Team economics 独立计算并写入团队协议。Homix 推荐从 Agent Side 的 10% 作为起始 Team Split；Team Leader 默认采用 Solo Pro。",
        },
      ],
      note: "$500 两年方案为一次预付，比连续两年各付 $288 节省 $76。Solo Pro 与 Team Leader 的 $3,650 已包含基础 affiliation fee。",
    },
    cap: {
      eyebrow: "年度封顶",
      title: "分成有终点，不会无限持续。",
      lead: "每位经纪人以自己的入职周年年为周期，eligible commission 产生的 Company Dollar 会持续累计；达到封顶后，当年余下时间进入 100% 佣金模式。",
      solo: {
        name: "Solo",
        split: "15%",
        cap: "$12,000 封顶",
      ...
      team: {
        ...
        stages: [
          ["封顶前", "10% 持续累计至 $10,000"],
          ["Team economics", "再按已签署的 Team Profile 处理团队分成"],
          ["Homix 封顶后", "改收 Transaction Fee；团队协议继续独立执行"],
        ],
      },
      reset: "Cap 按个人入职周年重置，不是每年 1 月 1 日。Outside referral、Sponsor payout、Transaction Fee 与第三方费用都不会形成 Cap credit。",
    },
    example: {
      eyebrow: "直接看数字",
      ...
      items: [
        ...
        },
        {
          ...
          amount: "$8,100",
          label: "Member Side",
          detail: "先产生 $1,000 Homix Company Dollar，再按推荐的 10% Team Profile 分给 Team Leader $900。",
        },
      ],
    ...
    faq: {
      ...
      items: [
        {
          q: "年度 Cap 到底是什么？",
          a: "Cap 是每个入职周年年内，正常分成最多为 Homix 产生的 Company Dollar：Solo 为 $12,000，Team Member 为 $10,000。达到后，当年剩余时间停止 Homix 分成并进入 100% 佣金模式。",
        },
        {
        ...
        },
        {
          ...
          a: "不是。Homix brokerage economics 固定为 90/10 与 $10,000 Homix Cap；Team Split 从剩余 Agent Side 中独立计算。Homix 推荐 10%，approved default presets 为 10%、15% 或 20%；团队真实提供客源时可采用获批的 10%–30% preset。任何 optional Team Cap 与生效配置都会写入已签署的 team profile。",
        },
        {
