...
const en = {
  ...
  toolDesc: {
    ...
    portal: "Sign in to training & resources",
  },
  buyMenu: [
  ...
  portal: {
    loginEyebrow: "Agent Portal",
    loginTitle: "Sign in",
    loginLead:
      "Private to the Homix team. Sign in to open training and the resource library.",
    nameLabel: "Your name",
    passwordLabel: "Access password",
    signIn: "Sign in",
    signingIn: "Signing in…",
    wrongPassword: "That password didn't match.",
    notReadyTitle: "Agent login is being set up.",
    notReadyBody:
      "The portal is in preview. Once an access password is set it locks to the Homix team — you can preview it for now.",
    previewCta: "Preview the portal",
    workspace: "Agent workspace",
    signOut: "Sign out",
    previewBanner:
      "Preview — login isn't enforced yet. This locks once an access password is set.",
    homeEyebrow: "Agent workspace",
    homeTitle: "Everything the team needs, in one place.",
    homeLead:
      "Private to Homix agents: the training library and the resource vault — your dashboard comes next.",
    open: "Open",
    comingSoon: "Coming soon",
    trainingCard: "Training",
    trainingCardDesc: "Video curriculum — client work, media, deals, compliance.",
    resourcesCard: "Resource library",
    resourcesCardDesc: "SOPs, scripts, templates, brand and marketing assets.",
    dashboardCard: "My dashboard",
    dashboardCardDesc: "Your leads, deals and earnings — coming soon.",
    trainingEyebrow: "Agent Portal · Training",
    trainingTitle: "Training videos, for the way Homix actually works.",
    trainingLead:
      "Watch on demand. These are internal to Homix — please don't share or record them.",
    trainingEmpty: "Videos are being added. Check back shortly.",
    resourcesEyebrow: "Agent Portal · Resources",
    resourcesTitle: "The Homix resource library.",
    resourcesLead:
      "Playbooks, scripts, templates and brand assets — everything to run a deal the Homix way.",
    resourcesEmpty: "Resources are being added. Check back shortly.",
    openResource: "Open",
    confidential: "Homix confidential · do not share",
    videoPending: "Connecting",
  },
  onboarding: {
...
const zh: Dict = {
  ...
  portal: {
    loginEyebrow: "经纪人门户",
    loginTitle: "登录",
    loginLead: "Homix 团队专属。登录后查看培训和资料库。",
    nameLabel: "你的姓名",
    passwordLabel: "访问密码",
    signIn: "登录",
    signingIn: "登录中…",
    wrongPassword: "密码不正确。",
    notReadyTitle: "经纪人登录正在搭建中。",
    notReadyBody:
      "门户目前为预览状态。设置访问密码后,此区域将仅限 Homix 团队访问——现在可以先预览。",
    previewCta: "预览门户",
    workspace: "经纪人工作台",
    signOut: "退出",
    previewBanner: "预览模式——登录尚未启用。设置访问密码后即会上锁。",
    homeEyebrow: "经纪人工作台",
    homeTitle: "团队需要的一切,都在这里。",
    homeLead: "Homix 经纪人专属:培训库与资料库,个人仪表盘即将上线。",
    open: "进入",
    comingSoon: "即将上线",
    trainingCard: "培训",
    trainingCardDesc: "视频课程——客户沟通、媒体、成交、合规。",
    resourcesCard: "资料库",
    resourcesCardDesc: "SOP、话术、模板、品牌与营销素材。",
    dashboardCard: "我的仪表盘",
    dashboardCardDesc: "你的客户、成交与收入——即将上线。",
    trainingEyebrow: "经纪人门户 · 培训",
    trainingTitle: "贴合 Homix 真实打法的培训视频。",
    trainingLead: "随时观看。内容仅供 Homix 内部使用——请勿分享或录制。",
    trainingEmpty: "视频正在上传中,请稍后再来。",
    resourcesEyebrow: "经纪人门户 · 资料",
    resourcesTitle: "Homix 资料库。",
    resourcesLead: "成交手册、话术、模板与品牌素材——用 Homix 的方式跑完每一单。",
    resourcesEmpty: "资料正在整理中,请稍后再来。",
    openResource: "打开",
