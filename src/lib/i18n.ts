...
const zh: Dict = {
  ...
  journal: {
    ...
    lead: "市场数据、社区深度解读、值得一读的观点——出自真正做事的人。",
    readMore: "阅读全文",
    by: "作者",
    backToJournal: "全部文章",
    minRead: "分钟阅读",
  ...
  offer: {
    ...
    fallbackBody: "我们正在配置这项功能。在此之前，欢迎直接致电或留言，我们会直接为你接收报价。",
    talkToUs: "联系我们",
  ...
  buyercoach: {
    eyebrow: "买家教练 · AI",
    title: "你的 AI 买房教练。",
    lead: "关于在美国买房的任何问题都可以问。基于 Homix 的指南训练，通俗易懂，随时为你解答。",
    ...
    resources: {
      ...
      selfBrandingDetail: {
        ...
        steps: [
          ...
          {
            title: "邮件签名设置",
            body: "我们建议每位经纪人在邮箱设置里配置好邮件签名，让客户收到邮件时第一眼就看到你的身份、联系方式和公司信息。",
            items: [
    ...
    phases: [
      {
        ...
        items: [
          ...
          "完成税务与薪资发放设置：W-9 表、直接存款资料，并登记紧急联系人。",
      ...
      steps: [
        {
          ...
          items: [
            ...
            "按贷款类型的最低首付：常规贷款 3–20%（低于 20% 需 PMI 保险）、FHA 3.5%（信用分 580+）、VA 0%（军人）、Jumbo 10–20%+（超过 2025 年上限 $806,500）。Co-op 董事会通常要求首付 20–25%，有时高达 50%+，且许多不接受 FHA/VA 贷款。",
          ],
        },
        {
          title: "第二步 — 组建购房团队",
      ...
      steps: [
        {
          ...
          body: "纽约住宅市场有三种主要产权形式——Co-op（合作公寓）、Condo（共管公寓）和独栋/联排住宅——每种类型的出售流程各有不同。Co-op 最为复杂：你出售的是公司股份而非不动产，每位买家都须经过楼盘董事会审批，通常需要 4–8 周。Condo 和独栋住宅限制较少，流程相对顺畅。",
          items: [
            "Co-op 卖家须在接受任何报价前，提前了解楼盘的转租规定、抵押比例限制与董事会申请材料要求——合同签署后交易流产，意味着白白浪费数月时间。",
        ...
        },
        {
          ...
          body: "在纽约，绝大多数卖家会委托备案经纪人代理出售。一位优秀的卖方经纪人带来的定价策略、营销能力、谈判经验与交易管理，往往能创造远超佣金的价值。签约前请在纽约州务厅（DOS）网站核实经纪人执照状态。",
          items: [
  ...
  sell: {
    ...
    valuationLead: "告诉我们你的房子，Homix 顾问会为你准备一份免费、无任何义务的估价。",
