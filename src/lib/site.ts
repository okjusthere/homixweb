...
export const neighborhoods: NeighborhoodTeaser[] = [
  {
    ...
    "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Flushing_Queens_March_2022_076.jpg/1280px-Flushing_Queens_March_2022_076.jpg",
  ...
  },
  {
    ...
    "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Long_Island_City_Skyline_2026.jpg/1280px-Long_Island_City_Skyline_2026.jpg",
    "photoCredit": "Kidfly182 · CC BY 4.0",
    "photoCreditUrl": "https://commons.wikimedia.org/wiki/File:Long_Island_City_Skyline_2026.jpg",
    "guide": {
      "en": "Long Island City occupies the westernmost edge of Queens, directly across the East River from Midtown Manhattan, and its transformation is among the most dramatic in the city: a former industrial dockyard and manufacturing district has been remade into a wall of glass residential towers. The housing stock skews decisively new. Along Center Boulevard and the Hunters Point South redevelopment, high-rise condominiums and rentals dominate — amenity-rich buildings with doormen, fitness centers, residents' lounges, and landscaped roof decks — many delivered within the past fifteen years. Projects like Gotham Point and the Paragon, which folds the historic Paragon Paint Factory into its base, sit beside thousands of mixed-income units. Inland toward Court Square and Vernon Boulevard, you'll also find converted loft buildings, low-rise prewar walk-ups, and a scattering of two-family houses. Sponsor condos and new-development units command a premium for water views; older co-ops and inland rentals offer comparatively more accessible entry points.\n\nTransit is the neighborhood's defining advantage. The Court Square complex links the 7, E, and G at all times, the M on weekdays, and the F on weekdays — putting riders one stop under the river into Manhattan. The 7 from Court Square or Vernon Boulevard–Jackson Avenue reaches Grand Central in roughly 7 minutes, while the E and M run to Midtown's 53rd Street corridor in about 15. NYC Ferry adds a scenic alternative: the East River route boards at the Hunters Point South landing for Midtown and Wall Street/Pier 11, and the Astoria route stops at LIC Landing in Gantry Plaza State Park. The Queensboro Bridge, Queens-Midtown Tunnel, and the BQE put drivers minutes from Manhattan and the wider borough.\n\nOpen space is the waterfront's signature. The contiguous Gantry Plaza State Park (12 acres, named for its preserved rail-car gantries) and Hunters Point South Park (11 acres) frame an East River esplanade with playgrounds, playing fields, kayak launches, and unobstructed United Nations and Midtown skyline views. Culturally, MoMA PS1 — a Museum of Modern Art affiliate housed in an 1892 Romanesque Revival former schoolhouse — anchors a long-standing arts scene of galleries and studios. Vernon Boulevard is the dining-and-retail spine, lined with cafes, bakeries, and restaurants, with more storefronts filling in around Center Boulevard. Schools fall within NYC Community School District 30; neighborhood elementary options include P.S./I.S. 78Q on Center Boulevard and P.S. 384, known as Hunters Point Elementary.",
      "zh": "长岛市（Long Island City，简称 LIC）位于皇后区最西端，隔东河与曼哈顿中城相望，是全纽约转型最戏剧化的街区之一：昔日的工业码头与制造区，如今已被一排排玻璃幕墙住宅塔楼取代。这里的房源以新建为主。沿 Center Boulevard 一线及 Hunters Point South 改造区，高层共管公寓（condo）与出租公寓占据主导——配备门房、健身房、住户会所与景观屋顶平台，多为近十五年内交付的高配置楼盘。Gotham Point、以及把历史建筑 Paragon 油漆厂融入裙楼的 Paragon 等项目，与数千套不同收入层级的住宅毗邻而立。往内陆靠近 Court Square 与 Vernon Boulevard，则可见改造 loft、低层战前步梯楼及少量双拼住宅。带水景的新盘 condo 价格偏高，而较旧的合作公寓（co-op）与内陆出租房则提供相对更易入手的选择。\n\n交通是本区最大的优势。Court Square 换乘枢纽全天接驳 7、E、G 线，工作日另有 M、F 线——一站即可穿越东河进入曼哈顿。从 Court Square 或 Vernon Blvd–Jackson Ave 乘 7 号线，约 7 分钟即达中央车站（Grand Central）；E、M 线约 15 分钟通往中城 53 街一带。NYC Ferry 渡轮则提供风景路线：East River 线于 Hunters Point South 码头登船，直抵中城与华尔街/11 号码头；Astoria 线则停靠 Gantry Plaza 州立公园内的 LIC Landing。Queensboro 桥、皇后中城隧道与 BQE 高速亦让驾车者数分钟即可往返曼哈顿与皇后区各处。\n\n滨水开放空间是本区的招牌。相连的 Gantry Plaza 州立公园（12 英亩，因保留的铁路货运龙门架而得名）与 Hunters Point South 公园（11 英亩），共同围出一条东河滨水步道，配有游乐场、运动场、皮划艇下水点，以及毫无遮挡的联合国总部与中城天际线景观。文化方面，MoMA PS1——隶属现代艺术博物馆、坐落于一栋 1892 年罗马式复兴风格旧校舍内——是本区由来已久的画廊与工作室艺术氛围的核心。Vernon Boulevard 是餐饮与零售主轴，咖啡馆、烘焙店与餐厅林立，Center Boulevard 周边的店铺亦在持续增加。学区方面，本区属纽约市第 30 学区（Community School District 30）；社区公立小学包括 Center Boulevard 上的 P.S./I.S. 78Q，以及被称为 Hunters Point Elementary 的 P.S. 384。"
    }
  },
  {
    "name": "Great Neck",
  ...
  },
  {
    ...
    "guide": {
      "en": "Manhasset sits on the North Shore of Nassau County, just east of the Queens line along Manhasset Bay, and grew from early-20th-century country estates into one of Long Island's most established residential addresses. The housing is overwhelmingly detached single-family, and the architecture reads like a catalog of the era: center-hall Colonials, Tudors, Cape Cods, and Mediterranean-style stucco homes with red-tile roofs, most built from the 1920s through the 1940s on generous, landscaped lots. Distinct enclaves give the hamlet its texture — the incorporated village neighborhoods around Plandome carry grander estate-scale homes near the water, while Strathmore, carved from former estate land, mixes classic Colonials and early ranches with substantial properties. Pricing sits firmly in the upper tier of the Long Island market, with entry-level houses well into seven figures and estate-caliber homes ranging considerably higher; co-ops and condos are limited, so buyers here are largely purchasing detached houses.\n\nFor commuters, the Long Island Rail Road's Port Washington Branch is the anchor. The Manhasset station, at Plandome Road and Maple Place, sits about 17 miles from Midtown; peak trains reach Penn Station in roughly 28 to 38 minutes, and because this branch runs direct to both Penn Station and Grand Central Madison without a Jamaica transfer, the East Side is equally reachable. The neighboring village of Plandome has its own station as well. Drivers rely on the Long Island Expressway (I-495) and the Northern State Parkway just to the south, with Northern Boulevard (Route 25A) cutting through town as the main east-west surface route.\n\nManhasset's signature draw is Americana Manhasset, the open-air luxury center anchoring the \"Miracle Mile\" along Northern Boulevard, where more than sixty designer houses — among them Hermes, Chanel, Cartier, Louis Vuitton, London Jewelers, and Hirshleifers — sit alongside restaurants such as Cipollini and Toku. Green space is woven through town: Whitney Pond Park offers a pond, tennis, basketball and handball courts, walking paths and a community pool, while Mary Jane Davies Green provides a gazebo, playground and lawn near Town Hall, and Manhasset Valley Park adds further trails. Education is served by the Manhasset Union Free School District (District No. 6 of North Hempstead), whose schools include Munsey Park Elementary and Shelter Rock Elementary for grades K-6, with all students continuing to Manhasset Secondary School for grades 7 through 12.",
      "zh": "曼哈塞特（Manhasset）位于纳苏县北岸，紧邻皇后区东侧、临曼哈塞特湾，由二十世纪初的乡村庄园逐步发展为长岛最成熟的住宅区之一。这里几乎清一色为独栋单户住宅，建筑风格宛如一部时代图鉴：中央门厅式殖民风（Colonial）、都铎风、科德角小屋，以及红瓦白墙的地中海灰泥宅邸，多建于1920至1940年代，坐落于宽敞且精心修整的地块之上。各处聚落各具气质——临水的普兰多姆（Plandome）一带为独立建制村庄，宅邸更显庄园气派；由旧庄园用地开发而成的斯特拉斯莫尔（Strathmore）则融合经典殖民风与早期牧场式住宅。价位稳居长岛市场高端，入门房源即达七位数中高段，庄园级宅邸则高出许多；公寓与共有产权房极少，购房者基本都是在选购独栋住宅。\n\n通勤方面，长岛铁路（LIRR）的华盛顿港线是核心依托。曼哈塞特站位于普兰多姆路与枫树坊交口，距中城约17英里；高峰时段列车约28至38分钟即可抵达宾州车站。该线直达宾州车站与大中央麦迪逊站，无需在牙买加站换乘，前往东城同样便捷；相邻的普兰多姆村亦设有独立车站。自驾者主要依托南侧的长岛高速（I-495）与北州景观大道，北方大道（25A公路）则横贯镇中，是主要的东西向地面干道。\n\n曼哈塞特的招牌是Americana Manhasset露天奢侈品中心，坐镇北方大道上的\"奇迹一英里\"，云集逾六十家设计师门店——爱马仕、香奈儿、卡地亚、路易威登、London Jewelers与Hirshleifers皆在其列，并配有Cipollini、Toku等餐厅。绿地遍布镇内：惠特尼池塘公园（Whitney Pond Park）设有池塘、网球、篮球与手球场、步道及社区泳池；镇政厅旁的Mary Jane Davies Green则有凉亭、游乐场与草坪；Manhasset Valley Park另辟步道。学区为曼哈塞特联合自由学区（北汉普斯特第6学区），旗下学校包括招收K至6年级的Munsey Park小学与Shelter Rock小学，全体学生升入Manhasset Secondary School就读7至12年级。"
    }
  },
  {
    "name": "Syosset",
    ...
    "guide": {
      "en": "Syosset sits in central Nassau County, a hamlet that grew from 19th-century farmland into a settled suburb after the Long Island Rail Road arrived and the postwar building boom followed. Its residential fabric is overwhelmingly detached single-family houses on generous lots, and the housing stock tells the era's story directly: mid-century ranches and split-levels, Cape Cods, and the period's classic Colonials, many since expanded or fully rebuilt, alongside a handful of converted farmhouses and newer custom homes. The north side runs hillier and more wooded, with winding streets and larger, often acre-plus parcels that edge toward the Gold Coast in feel; the southern half tends toward newer, more uniform construction. Ownership is almost entirely fee-simple houses rather than co-ops or condos, and pricing spans a broad band — comfortable four-bedroom Colonials in the solid mid-market, rising into the millions for expanded estates on the larger northern lots.\n\nFor commuters, the headline is the LIRR Port Jefferson Branch. The Syosset station, at Jackson Avenue and Underhill Boulevard, is electrified and roughly 31 miles from Manhattan; trains reach Penn Station in about 40 to 55 minutes and, since the opening of Grand Central Madison, also run to the East Side terminal. Drivers sit between two major arteries — the Long Island Expressway (I-495) to the south and the Northern State Parkway — putting Jericho, the Nassau corridor, and the wider region within easy reach by car.\n\nThe walkable downtown runs along Jackson Avenue, a low-rise main street of independent boutiques, bakeries, coffee shops, and a deep, varied dining bench spanning Greek, Japanese sushi, Italian, and American kitchens. Open space is anchored by Stillwell Woods Preserve, roughly 270 acres of oak-barrens and old-field habitat laced with hiking, equestrian, and mountain-biking trails; the Nassau-Suffolk Greenbelt runs through it and links south toward Trail View State Park and Bethpage. The village of Oyster Bay and the north-shore waterfront lie just beyond. Public schools belong to the Syosset Central School District, which includes Syosset High School, Harry B. Thompson and South Woods middle schools, and elementary schools such as Berry Hill, South Grove, Robbins Lane, Village, and A.P. Willits.",
      "zh": "西奥塞特（Syosset）位于纳苏县中部，由十九世纪的农场逐步发展而来——长岛铁路通车后，战后建房热潮随之到来，将这里塑造成一处成熟的近郊社区。其住宅以独栋单户为主，地块普遍宽敞，房型也清晰记录着各个年代：上世纪中叶的牧场式（ranch）、错层式（split-level）住宅、Cape Cod 小宅，以及那个时期经典的殖民式（Colonial），许多已经过扩建或重建，间或还有改建的旧农舍与新建的定制大宅。北区地势更起伏、林木更密，街道蜿蜒，地块常达一英亩以上，颇有\"黄金海岸\"的气息；南区则多为较新、较为整齐的建筑。产权几乎全为独栋房屋，鲜见合作公寓或共管公寓；价位区间较宽——四卧殖民式多落在稳健的中端，北区大地块上的扩建大宅则可上探至数百万美元。\n\n通勤方面，重头是长岛铁路 Port Jefferson 支线。西奥塞特车站位于 Jackson Avenue 与 Underhill Boulevard 路口，已电气化，距曼哈顿约 31 英里；列车约 40 至 55 分钟可达 Penn Station，自 Grand Central Madison 启用后，也可直达中城东侧终点站。自驾则夹在两条主干道之间——南侧为长岛快速路（I-495），北侧为 Northern State Parkway，前往 Jericho、纳苏走廊及更广区域都很便捷。\n\n可步行的市中心沿 Jackson Avenue 展开，是一条低层主街，遍布独立精品店、面包房、咖啡馆，餐饮选择丰富而多元，涵盖希腊菜、日式寿司、意大利菜与美式餐厅。绿地以 Stillwell Woods Preserve 为核心，约 270 英亩的橡树荒原与旧野生境，交织着徒步、骑马与山地自行车道；Nassau-Suffolk Greenbelt 穿园而过，向南连通 Trail View 州立公园直至 Bethpage。蚝湾镇（Oyster Bay）与北岸海滨近在咫尺。公立学校归属 Syosset Central School District，包括 Syosset 高中，Harry B. Thompson 与 South Woods 两所初中，以及 Berry Hill、South Grove、Robbins Lane、Village、A.P. Willits 等小学。"
    }
  },
  {
    "name": "Jericho",
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1534430480872-3498386e7856?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1518391846015-55a9cc003b25?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1555109307-f7d9da25c244?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1416331108676-a22ccb276e35?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1568605114967-8130f3a36994?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "image": "https://images.unsplash.com/photo-1576941089067-2de3c901e126?auto=format&fit=crop&w=1280&q=80",
    "guide": {
  ...
  },
  {
    ...
    "guide": {
      "en": "Astoria occupies the northwestern corner of Queens along the East River, and its residential fabric mixes old-world solidity with a steady wave of new construction. The backbone is pre-war brick: low-rise cooperative buildings, many dating to the 1920s and 1930s, cluster around Ditmars Boulevard and Steinway Street and offer some of the more accessible entry points into ownership. Alongside them run blocks of attached and semi-detached row houses and two- and three-family homes, several with private driveways, patios, and basements that are rare elsewhere in the city and prized by buyers seeking rental income or room for extended family. Closer to the waterfront, Broadway, and 21st Street, a newer generation of glass-and-steel condominiums has reshaped the skyline. As a rule, co-ops trade below the neighborhood median, detached and multi-family houses above it, and new condos at a premium for their finishes and views.\n\nFor commuters, the elevated N and W trains run the length of 31st Street, with stops at Astoria–Ditmars Boulevard (the northern terminus), Astoria Boulevard, 30th Avenue, Broadway, and 36th Avenue; the M and R add a second option at Steinway Street. The N/W reaches Times Square in roughly 18 to 20 minutes, putting most of Midtown within a 20-to-30-minute door-to-platform window. The NYC Ferry Astoria route adds a scenic alternative, linking the Astoria landing to Roosevelt Island, Long Island City, Midtown's East 34th Street, and the Upper East Side. Drivers reach the Grand Central Parkway, the RFK (Triborough) Bridge, and the Brooklyn-Queens Expressway within minutes.\n\nOpen space centers on Astoria Park, a riverside expanse beneath the Hell Gate and RFK bridges, home to a running track, tennis courts, and the landmarked Astoria Pool — the city's largest and oldest WPA-era pool. The dining and retail scene is the neighborhood's signature, spread across three corridors: Steinway Street, 30th Avenue, and Ditmars Boulevard, where bakeries, grocers, cafes, and restaurants span cuisines from around the world. Culture runs deep here: Kaufman Astoria Studios and the adjacent Museum of the Moving Image anchor a working film district, while Socrates Sculpture Park and the Noguchi Museum sit by the water to the north. Public schools fall within Community School District 30, which covers Astoria; named schools include P.S. 122 Mamie Fay on Ditmars Boulevard, P.S. 17 Henry David Thoreau, and the Frank Sinatra School of the Arts High School.",
      "zh": "阿斯托利亚（Astoria）位于皇后区西北角、东河之畔，住宅形态在老派的厚重与持续的新建浪潮之间交织。区域的根基是战前红砖建筑：大量建于1920、1930年代的低层合作公寓（co-op）聚集在Ditmars大道与Steinway街一带，是本区门槛较低的置业选择之一。与之相邻的，是一排排联排与半独立式排屋，以及两到三户型住宅，其中不少配有私人车道、后院和地下室——这在纽约市其他地方相当罕见，深受看重租金收益或多代同堂买家的青睐。靠近水岸、Broadway与21街一带，新一代玻璃幕墙公寓则重塑了天际线。总体而言，合作公寓价格低于本区中位数，独立与多户住宅高于中位数，新建公寓则因装修与景观而溢价。\n\n通勤方面，高架的N、W线沿31街贯穿全区，设Astoria–Ditmars大道（北端终点站）、Astoria大道、30大道、Broadway与36大道等站；Steinway街另有M、R线可选。乘N/W线约18至20分钟即可抵达时报广场，前往中城大部分地点门到站约20至30分钟。纽约渡轮（NYC Ferry）阿斯托利亚航线提供风景优美的另一选择，连接阿斯托利亚码头至罗斯福岛、长岛市、中城东34街及上东区。驾车则可在数分钟内接入大中央公园大道、RFK（Triborough）大桥与布鲁克林–皇后区高速。\n\n绿地以阿斯托利亚公园为核心，这片临河绿地横卧于Hell Gate桥与RFK桥之下，设有跑道、网球场，以及被列为地标的阿斯托利亚泳池——全市最大、最古老的WPA时代泳池。餐饮零售是本区的招牌，分布于三条主街：Steinway街、30大道与Ditmars大道，烘焙坊、食品杂货、咖啡馆与餐厅汇聚了来自世界各地的风味。文化底蕴深厚：Kaufman Astoria片场与紧邻的活动影像博物馆（Museum of the Moving Image）撑起一片运作中的影视区，北侧水畔则有苏格拉底雕塑公园与野口勇博物馆（Noguchi Museum）。公立学校隶属第30学区，该学区覆盖阿斯托利亚；区内学校包括Ditmars大道上的P.S. 122 Mamie Fay、P.S. 17 Henry David Thoreau，以及法兰克·辛纳屈艺术高中（Frank Sinatra School of the Arts）。"
    }
  },
  {
    ...
    "guide": {
      "en": "Jackson Heights began around 1914 as one of America's first planned \"garden city\" communities, laid out by the Queensboro Corporation and shaped by the era's Garden City ideals. The result, now a New York City Historic District, is a rare collection of pre-war garden-apartment co-ops — brick and stucco buildings wrapped around private, landscaped interior courtyards, with named complexes such as Linden Court, The Chateau, The Towers, and Hampton Court. The housing stock is overwhelmingly cooperative, with some condos and clusters of attached \"garden homes\" built after the mid-1920s. Co-ops here remain among the more accessible homeownership entry points in New York City: one-bedroom pre-war units typically trade in the mid-to-high six figures of the lower range, while larger units and the most sought-after courtyard buildings in the historic district command a premium.\n\nTransit is the neighborhood's anchor. The 74th Street–Roosevelt Avenue / Jackson Heights complex brings five lines together: the 7 (IRT Flushing), plus the E, F, R, and weekday M (IND Queens Boulevard). The 7 runs direct to Grand Central and Times Square in roughly 20 minutes, while the E and F reach Midtown's Lexington Avenue–53rd Street and 50th Street stops in a comparable ride; the R offers a one-seat trip toward Herald Square and Lower Manhattan. The hub is also a major bus interchange, and the Grand Central Parkway and Brooklyn-Queens Expressway put LaGuardia Airport and the wider road network within easy reach.\n\nOpen space and commerce define daily life. Travers Park, between 77th and 78th Streets, anchors the area with a year-round Sunday Greenmarket, while the 34th Avenue Open Street — co-named \"Paseo Park,\" at roughly 1.3 miles the city's largest — runs a car-free corridor through the heart of the district. The commercial streets are a global pantry: 37th Avenue and Roosevelt Avenue brim with Himalayan momo, Colombian arepas, Ecuadorian seafood, and Indian sweets, while the 74th Street corridor is a renowned destination for South Asian groceries, jewelry, and restaurants. The neighborhood sits in New York City Geographic District 30; area schools include P.S. 69 Jackson Heights, I.S. 145 Joseph Pulitzer, and P.S. 212.",
      "zh": "杰克逊高地（Jackson Heights）始建于约1914年，由Queensboro公司规划，是美国最早的\"花园城市\"社区之一，深受当时花园城市理念影响。如今它已成为纽约市历史保护区，保留着罕见的战前花园公寓合作公寓群——砖石与灰泥建筑环绕着私家景观内庭院，著名楼盘包括Linden Court、The Chateau、The Towers与Hampton Court。住房以合作公寓（co-op）为主，另有部分共有公寓（condo）及1920年代中期后建成的连排\"花园住宅\"。这里的合作公寓仍是全纽约市置业门槛较低的选择之一：战前一居室通常处于六位数偏低区间的中高段，而面积更大的单元及历史区内最受追捧的庭院楼盘则需溢价。\n\n交通是本区的核心优势。74街–罗斯福大道/杰克逊高地枢纽汇集五条地铁线：7号线（法拉盛线），以及E、F、R和工作日运行的M线（皇后大道线）。7号线直达中央车站与时报广场约需20分钟，E、F线抵达中城列克星敦大道–53街及50街站车程相近；R线则可一线直达先驱广场与下曼哈顿。该枢纽亦是重要的公交换乘点，大中央公园大道与布鲁克林-皇后高速公路让拉瓜迪亚机场及周边路网近在咫尺。\n\n开放空间与商业塑造了日常生活。Travers Park位于77街与78街之间，常年于周日举办农夫市集；而34大道开放街道——别名\"Paseo Park\"，约1.3英里、为全市最长——在区域核心开辟出一条无车走廊。商业街区宛如全球美食地图：37大道与罗斯福大道汇聚喜马拉雅momo、哥伦比亚arepa、厄瓜多尔海鲜与印度甜点，74街走廊则以南亚食材、金饰与餐馆闻名。本区隶属纽约市第30学区，区内学校包括P.S. 69 Jackson Heights、I.S. 145 Joseph Pulitzer与P.S. 212。"
    }
  },
  {
    "name": "Sunnyside",
    ...
    "guide": {
      "en": "Sunnyside sits in western Queens just east of Long Island City, and its character is anchored by Sunnyside Gardens — built between 1924 and 1928 as the first planned garden community in the United States and designated a New York City Historic District in 2007. Across roughly sixteen low-rise superblocks, rows of one- to three-family brick houses, co-op buildings, and rental apartments wrap around shared interior courts and common gardens, a deliberate departure from the standard street grid. Beyond the Gardens, the housing stock runs to six-story prewar apartment buildings — many since converted to co-ops or condos — alongside more brick row houses with small front yards. Co-ops form the most accessible entry point, typically trading from the mid-six figures for studios and one-bedrooms into higher tiers for larger units; condos command a premium over co-ops, and one- and two-family houses generally trade in the high six figures, keeping the area comparatively attainable for the borough.\n\nFor commuters, the headline is the elevated 7 train running above Queens Boulevard, with three local stations in the neighborhood — 40th Street–Lowery Street, 46th Street–Bliss Street, and 33rd Street–Rawson Street — plus the Greenpoint Avenue station nearby. Trains reach Midtown Manhattan and Grand Central in roughly fifteen minutes, among the quickest commutes in the borough, with cross-platform transfers feeding the rest of the system at Queensboro Plaza. Drivers have the Brooklyn-Queens Expressway and the Long Island Expressway, the latter feeding the Queens-Midtown Tunnel into Manhattan, while the Pulaski Bridge links the area to Greenpoint, Brooklyn over Newtown Creek.\n\nOpen space and street life center on the pedestrian Bliss and Lowery plazas beneath the 7 line, while the private Sunnyside Gardens Park serves the historic district. The commercial spine runs along Greenpoint Avenue, Skillman Avenue, and Queens Boulevard, where the illuminated Art Deco \"Sunnyside\" arch near 46th Street marks the gateway to Queens; the corridor is dense with restaurants spanning Latin American, Filipino, Romanian, Italian, and Himalayan kitchens, plus bakeries, cafes, and groceries, much of it programmed by the Sunnyside Shines business district. Public schools fall within Community School District 30, which also covers Astoria, Long Island City, and Jackson Heights; named schools include P.S. 150, P.S. 11, P.S. 343 (The Children's Lab School), and I.S. 125.",
      "zh": "阳光区（Sunnyside）位于皇后区西部、长岛市以东，其气质由\"阳光花园区\"（Sunnyside Gardens）奠定——它建于1924至1928年间，是全美第一个规划型花园社区，2007年被列为纽约市历史保护区。在约十六个低层\"超级街区\"中，一至三户的砖砌联排住宅、合作公寓与出租公寓楼环绕着共享的内庭与公共花园布置，刻意有别于常规的街道网格。在花园区之外，住房存量以六层战前公寓楼为主，许多已改为合作公寓（co-op）或共有公寓（condo），另有带小前院的砖砌联排屋。合作公寓是最易入手的选择，开间与一居室多自六十万美元中段起步，较大户型更高；共有公寓价格高于合作公寓，独栋及双拼住宅一般在六十万至九十万美元区间，在皇后区中相对可负担。\n\n通勤方面的亮点是沿皇后大道高架运行的7号线，社区内设三座本地车站——40街-Lowery、46街-Bliss、33街-Rawson——附近还有Greenpoint Avenue站。列车约十五分钟即可抵达曼哈顿中城与中央车站，是全区最快捷的通勤之一，并可在Queensboro Plaza换乘接入全市地铁网。自驾者可经布鲁克林-皇后高速（BQE）与长岛高速（LIE），后者接通往曼哈顿的皇后-中城隧道；Pulaski大桥则跨越Newtown Creek连接布鲁克林的Greenpoint。\n\n公共空间与街区生活以7号线下方的Bliss与Lowery步行广场为中心，私属的Sunnyside Gardens Park则服务于历史保护区。商业主轴沿Greenpoint Avenue、Skillman Avenue与皇后大道展开，46街附近那座灯光装饰艺术风格的\"Sunnyside\"拱门被视为\"皇后区门户\"；沿线餐馆密集，涵盖拉美、菲律宾、罗马尼亚、意大利与喜马拉雅风味，并有面包房、咖啡馆与杂货店，许多活动由Sunnyside Shines商业改进区组织。公立学校隶属第30学区（同时覆盖阿斯托利亚、长岛市与杰克逊高地）；区内学校包括P.S. 150、P.S. 11、P.S. 343（The Children's Lab School）与I.S. 125。"
    }
  },
  {
  ...
  },
  {
    ...
    "guide": {
      "en": "New Hyde Park is an incorporated village straddling the Queens–Nassau border, where New York City's grid gives way to Long Island's garden suburbs. Its character is firmly residential: detached single-family houses line quiet blocks, accounting for the overwhelming majority of the housing stock. Much of it dates to the building boom of the 1940s through 1960s — capes, colonials, ranches, and split-levels, most with private driveways and modest yards — with a thinner layer of two-family homes near the commercial corridors. Compared with pricier North Shore villages nearby, entry points here tend to be more attainable, and turnkey detached houses with three to four bedrooms remain the everyday trade, giving the area a settled, suburban feel within easy reach of the city.\n\nFor commuters, the headline is the Long Island Rail Road Main Line. The New Hyde Park station — recently rebuilt with twelve-car platforms, ramps, and shelters as part of the Third Track expansion — runs to both Penn Station and Grand Central Madison, with peak rides reaching Manhattan in roughly 25 to 35 minutes. The same Third Track project eliminated the New Hyde Park Road grade crossing, replacing it with a vehicle underpass that ended the daily backups behind lowered gates. Drivers reach the Cross Island Parkway, Northern State Parkway, and the Long Island Expressway within minutes, and the Northwell Health/Long Island Jewish medical campus sits just to the north.\n\nDaily life centers on three walkable corridors — Jericho Turnpike, Hillside Avenue, and Lakeville/Marcus Avenue, the last a busy South Asian dining-and-grocery strip anchored by spots like Southern Spice on Hillside Avenue and Apna Bazar on Lakeville Road, alongside halal butchers, sweet shops, and produce markets. School districts vary block to block: much of the village sits in the Herricks Union Free School District (Center Street and Denton Avenue elementaries, Herricks Middle, and Herricks High on Shelter Rock Road), while other sections fall under the New Hyde Park–Garden City Park Union Free School District, an elementary district that feeds the Sewanhaka Central High School District and New Hyde Park Memorial High School.",
      "zh": "新海德公园（New Hyde Park）是一座横跨皇后区与拿骚县边界的自治村落，城市的棋盘式街道在此过渡为长岛的花园式郊区。这里的氛围以居住为主：独栋单户住宅排列在安静的街区，占据了绝大部分的住房存量，多数建于1940至1960年代的建房热潮——包括Cape式、殖民式、平房（ranch）与错层式住宅，大多配有私家车道和小院落，靠近商业街一带还点缀着少量双拼住宅。与附近价位更高的北岸村镇相比，这里的入门门槛更为亲民，三至四居室、可拎包入住的独栋住宅是日常成交的主力，让整个区域在邻近市区的同时保有沉静的郊区气质。\n\n通勤方面的重头戏是长岛铁路（LIRR）主线。新海德公园车站作为\"第三轨道\"扩建工程的一部分，已重建为可停靠十二节车厢的月台，并增设坡道与候车棚；列车同时通往宾州车站（Penn Station）与中央车站麦迪逊站（Grand Central Madison），高峰时段约25至35分钟即可抵达曼哈顿。同一工程取消了New Hyde Park Road的平交道口，改建为车行地下通道，终结了昔日候闸排队的拥堵。驾车数分钟即可上Cross Island Parkway、Northern State Parkway与长岛高速；北侧紧邻Northwell Health／Long Island Jewish大型医疗园区。\n\n日常生活围绕三条适合步行的商业走廊展开——Jericho Turnpike、Hillside Avenue，以及Lakeville／Marcus Avenue，后者是热闹的南亚餐饮与杂货街，云集Hillside Avenue上的Southern Spice、Lakeville Road上的Apna Bazar，以及清真肉铺、甜品店和生鲜市场。学区随街区而异：村内大部分属于Herricks联合自由学区（含Center Street、Denton Avenue小学，Herricks初中，以及位于Shelter Rock Road的Herricks高中），其余部分则归New Hyde Park–Garden City Park联合自由学区——一个小学学区，升入Sewanhaka中央高中学区及New Hyde Park Memorial高中。"
    }
  },
  {
    "name": "Hicksville",
    ...
    "guide": {
      "en": "Hicksville sits at the geographic center of Nassau County and grew up around its railroad, expanding rapidly during the post-war suburban boom. South of Old Country Road, much of the housing belongs to that Levitt-era wave — modest Cape Cods and ranches on compact lots, built quickly for commuting families in the late 1940s and 1950s — while blocks to the north add split-levels, raised ranches, and Colonials from the 1960s and early 1970s on somewhat larger footprints. The stock is overwhelmingly detached single-family, with a scattering of two-family houses and, increasingly, new transit-oriented apartments and townhomes rising near the station through projects like Fieldstone at North Broadway. By Nassau standards, Hicksville remains one of the more attainable entry points, which makes it a practical first-home and investment market rather than a luxury enclave.\n\nFor commuters, the Long Island Rail Road is the defining asset. Hicksville is the busiest station east of the Jamaica–Penn–Grand Central core: a Main Line hub and transfer point for the Port Jefferson and Ronkonkoma branches, with direct trains reaching Penn Station in roughly 47 minutes and Grand Central Madison on the East Side in about 40 to 50 minutes. The completed Main Line Third Track has added capacity through the corridor, and a new Amtrak Northeast Regional stop has been announced here. By car, NY 106/107 (Broadway) runs straight through downtown to interchanges with the Northern State Parkway and the Long Island Expressway (I-495).\n\nDowntown is in the middle of a state-backed revitalization, with grants funding station and public-space upgrades, a more walkable Broadway, and hundreds of new mixed-use units. Broadway and South Broadway anchor the retail and dining scene, including a lively South Asian commercial strip — Patel Brothers and Apna Bazar groceries on South Broadway, plus restaurants like Chennai Dosas and Taste of Mumbai. The former Broadway Mall, now Broadway Commons, is being reimagined as an open-concept center. Schooling falls under the Hicksville Union Free School District, whose campuses include Burns Avenue, Dutch Lane, and Lee Avenue elementary schools, Hicksville Middle School, and Hicksville High School.",
      "zh": "希克斯维尔（Hicksville）位于纳苏县地理中心，围绕铁路而兴，在战后郊区开发热潮中迅速成长。老乡村路（Old Country Road）以南的住宅多属莱维特（Levitt）时代那一波——上世纪四十年代末至五十年代为通勤家庭快速建造的小型科德角式（Cape Cod）与牧场式（ranch）房屋，地块紧凑；以北街区则增添了六十至七十年代初的错层屋、抬高牧场式与殖民地式住宅，占地略大。房源以独栋单户住宅为绝对主体，夹杂少量双拼住宅，并有越来越多沿车站新建的公寓与联排住宅（如 North Broadway 的 Fieldstone 项目）。按纳苏的标准，希克斯维尔仍属较易入手的区域，是务实的首套房与投资市场，而非豪宅聚集地。\n\n通勤方面，长岛铁路（LIRR）是这里的核心优势。希克斯维尔是牙买加—宾州车站—中央车站枢纽以东最繁忙的车站，既是干线（Main Line）枢纽，也是港杰斐逊线与朗肯科马线的换乘点；直达列车约 47 分钟可至宾州车站（Penn Station），约 40 至 50 分钟抵达东城的麦迪逊中央车站（Grand Central Madison）。干线第三轨已建成通车，提升了走廊运力，并已宣布在此新增美铁东北区域线停靠站。自驾方面，NY 106/107 号公路（Broadway）贯穿市中心，直通北州大道（Northern State Parkway）与长岛快速路（I-495）。\n\n市中心正进行州政府支持的振兴改造：拨款用于车站与公共空间升级、打造更宜步行的 Broadway，并新增数百套混合用途住宅。Broadway 与 South Broadway 构成零售与餐饮主轴，其中包括热闹的南亚商业街——South Broadway 上的 Patel Brothers、Apna Bazar 等杂货店，以及 Chennai Dosas、Taste of Mumbai 等餐厅。原 Broadway Mall（现更名 Broadway Commons）正改造为开放式商业中心。学区为希克斯维尔联合自由学区（Hicksville UFSD），辖下包括 Burns Avenue、Dutch Lane、Lee Avenue 等小学，以及希克斯维尔初中和希克斯维尔高中。"
    }
  },
  {
    "name": "Floral Park",
...
> = {
  ...
  "astoria": {
    "transit": {
      "en": "Elevated N/W trains run along 31st Street (Astoria–Ditmars Blvd, Astoria Blvd, 30th Ave, Broadway, 36th Ave), with M/R at Steinway Street; the N/W reaches Times Square in about 18-20 minutes. The NYC Ferry Astoria route links the Astoria landing to Roosevelt Island, Long Island City, East 34th Street, and the Upper East Side.",
      "zh": "高架N/W线沿31街设站（Astoria–Ditmars大道、Astoria大道、30大道、Broadway、36大道），Steinway街另有M/R线；N/W线约18至20分钟可达时报广场。纽约渡轮阿斯托利亚航线连接阿斯托利亚码头至罗斯福岛、长岛市、东34街与上东区。"
    },
    "schools": {
      "en": "Astoria is served by NYC Community School District 30. Named schools include P.S. 122 Mamie Fay on Ditmars Boulevard, P.S. 17 Henry David Thoreau, and the Frank Sinatra School of the Arts High School.",
      "zh": "阿斯托利亚隶属纽约市第30社区学区。区内学校包括Ditmars大道上的P.S. 122 Mamie Fay、P.S. 17 Henry David Thoreau，以及法兰克·辛纳屈艺术高中（Frank Sinatra School of the Arts）。"
    },
    "character": {
  ...
  "jackson-heights": {
    "transit": {
      "en": "The 74th Street–Roosevelt Avenue / Jackson Heights hub serves five lines — the 7, E, F, R, and weekday M. The 7 reaches Grand Central and Times Square in about 20 minutes, with the E and F running direct to Midtown.",
      "zh": "74街–罗斯福大道/杰克逊高地枢纽汇集7、E、F、R及工作日M共五条线路。7号线约20分钟直达中央车站与时报广场，E、F线则直通中城。"
    },
    "schools": {
    ...
    "character": {
      "en": "A landmarked historic district of 1910s–20s garden-apartment co-ops set around private courtyards, paired with some of the city's most globally diverse food and shopping corridors and the car-free Paseo Park open street. Housing is predominantly co-op, with some condos and garden homes.",
      "zh": "由1910–20年代花园公寓合作公寓组成的历史保护区，楼宇环抱私家庭院，毗邻全市最具国际多元色彩的美食与购物街区，以及无车的Paseo Park开放街道。住房以合作公寓为主，另有部分共有公寓与花园住宅。"
    },
    "bestFor": {
      "en": "Buyers seeking an accessible NYC co-op entry point with pre-war character and a fast, multi-line commute to Midtown, plus value-focused investors drawn to a dense, transit-rich, food-and-retail neighborhood.",
      "zh": "适合希望以较低门槛购入纽约市合作公寓、青睐战前韵味与多线快速通勤中城的买家，以及看重高密度、交通便利、餐饮零售繁荣街区价值的投资者。"
    }
  },
  "sunnyside": {
    "transit": {
      "en": "The elevated 7 train serves three local stations — 40th St–Lowery St, 46th St–Bliss St, and 33rd St–Rawson St — plus Greenpoint Avenue nearby, reaching Midtown and Grand Central in roughly 15 minutes. The BQE, Long Island Expressway (to the Queens-Midtown Tunnel), and Pulaski Bridge add road access.",
      "zh": "高架7号线设有三座本地车站——40街-Lowery、46街-Bliss、33街-Rawson，附近另有Greenpoint Avenue站，约15分钟可达中城与中央车站。布鲁克林-皇后高速（BQE）、长岛高速（接皇后-中城隧道）及Pulaski大桥提供公路通行。"
    },
    "schools": {
      "en": "Sunnyside is part of Community School District 30, which also covers Astoria, Long Island City, and Jackson Heights. Named public schools include P.S. 150, P.S. 11, P.S. 343 (The Children's Lab School), and I.S. 125.",
      "zh": "阳光区隶属第30学区，该学区还覆盖阿斯托利亚、长岛市与杰克逊高地。区内公立学校包括P.S. 150、P.S. 11、P.S. 343（The Children's Lab School）与I.S. 125。"
    },
    "character": {
  ...
  "douglaston-little-neck": {
    "transit": {
      "en": "LIRR Port Washington Branch serves Douglaston (about 28 min) and Little Neck (about 30 min) direct to Penn Station, with continuing service to Grand Central Madison. The Cross Island Parkway and Long Island Expressway (I-495) handle driving.",
      "zh": "长岛铁路华盛顿港线设道格拉斯顿站（约28分钟）与小颈站（约30分钟），直达宾州车站，并续行至中央车站麦迪逊站。驾车可经跨岛大道与长岛高速（I-495）。"
    },
    "schools": {
      "en": "The area falls within NYC Community School District 26. Nearby schools include P.S. 98 The Douglaston School, M.S. 67 Louis Pasteur in Little Neck, and Benjamin N. Cardozo High School in adjacent Bayside.",
  ...
  "new-hyde-park": {
    "transit": {
      "en": "LIRR Main Line at New Hyde Park station, with both Penn Station and Grand Central Madison service reaching Manhattan in about 25–35 minutes at peak. The Cross Island Parkway, Northern State Parkway, and Long Island Expressway are minutes away by car.",
      "zh": "长岛铁路主线新海德公园车站，同时通往宾州车站与中央车站麦迪逊站，高峰约25至35分钟抵达曼哈顿。驾车数分钟即可上Cross Island Parkway、Northern State Parkway与长岛高速。"
    },
    "schools": {
      "en": "Districts vary by block. Much of the village lies in the Herricks Union Free School District (Center Street and Denton Avenue elementaries, Herricks Middle, Herricks High); other sections fall under the New Hyde Park–Garden City Park UFSD, which feeds the Sewanhaka Central High School District and New Hyde Park Memorial High School.",
  ...
  "hicksville": {
    "transit": {
      "en": "LIRR Hicksville is a Main Line hub with direct service to Penn Station (~47 min) and Grand Central Madison (~40–50 min), plus transfers to the Port Jefferson and Ronkonkoma branches; NY 106/107 connects to the Northern State Parkway and Long Island Expressway (I-495).",
      "zh": "长岛铁路希克斯维尔站为干线枢纽，直达宾州车站约 47 分钟、麦迪逊中央车站约 40–50 分钟，并可换乘港杰斐逊线与朗肯科马线；NY 106/107 号公路连通北州大道与长岛快速路（I-495）。"
    },
    "schools": {
  ...
  "floral-park": {
    "transit": {
      "en": "LIRR Floral Park station (Tulip & Atlantic Aves) sits at the Main Line / Hempstead Branch split: about 30–35 minutes to Penn Station and roughly 40 minutes to Grand Central Madison. The Cross Island Parkway, Grand Central Parkway, and Jericho Turnpike (Route 25B) are minutes away.",
      "zh": "长岛铁路 Floral Park 车站（Tulip 与 Atlantic 大道交口）位于主线与 Hempstead 支线分叉处：约 30–35 分钟可达宾州车站，约 40 分钟直达 Grand Central Madison。Cross Island Parkway、Grand Central Parkway 与 Jericho Turnpike（25B 号公路）均在数分钟车程内。"
    },
    "schools": {
