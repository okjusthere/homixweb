 ...
 * pages. These are PUBLIC URLs/IDs (they ship to the browser in an iframe), not
 * secrets — so they can be hardcoded here or overridden with NEXT_PUBLIC_* env
 * vars in Vercel (a redeploy applies env changes).
 *
