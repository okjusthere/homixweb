-- ============================================================
-- Homix career-history go-live — run this file ONCE in the
-- Supabase Dashboard -> SQL Editor -> New query -> paste -> Run.
-- Everything is idempotent; re-running is harmless.
-- (Names were already normalized directly; this adds the two new
-- columns and links every advisor to their MLS member id.)
-- ============================================================
